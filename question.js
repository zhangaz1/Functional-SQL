...
To do this, you must implement the query()
function.
This
...
orderBy should be called after groupBy, so the values passed to orderBy
function are the grouped results by the groupBy
function.
